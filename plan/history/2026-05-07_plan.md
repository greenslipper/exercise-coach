...
| Thu | May 7 | Rest / Core + Upper | Intervals done Tue. Full rest or core/upper if Wed was missed. Let calves recover from the Tue combined load. |
| Fri | May 8 | Rest | — |
| Sat | May 9 | Yasmin's program | Full session — leg session 2 of the week. Single-leg extension ~35 kg (alternating: May 5 double, so May 9 = single). Do in the morning — Forth folk festival. |
